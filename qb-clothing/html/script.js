...
$(document).on('click', '.clothing-menu-option-item-right', function(e){
    ...
    if (canChange) {
        if (hasTracker && clothingCategory == "accessory") {
            $.post('http://qb-clothing/TrackerError');
            return
        } else {
...
QBClothing.ReloadOutfits = function(outfits) {
    ...
    $.each(outfits, function(index, outfit){
        var elem = '<div class="clothing-menu-option" data-myOutfit="'+(index + 1)+'"> <div class="clothing-menu-option-header"><p>'+outfit.outfitname+'</p></div><div class="clothing-menu-myOutfit-option-button"><p>SELECT</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>REMOVE</p></div></div>'
...
QBClothing.Open = function(data) {
    ...
    $(".clothing-menu-spawn-container").css("display", "none");
...
QBClothing.SetMaxValues = function(maxValues) {
    $.each(maxValues, function(i, cat){
        if (cat.type == "spawn") {
            var containers = $(".clothing-menu-spawn-container").find('[data-type="'+i+'"]');
