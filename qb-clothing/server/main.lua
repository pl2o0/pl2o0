...
QBCore.Commands.Add("helm", "Put/remove Helmet", {}, false, function(source, args)
    TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 1) -- Hat
end)

QBCore.Commands.Add("bril", "Put/remove bril", {}, false, function(source, args)
	TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 2)
end)

QBCore.Commands.Add("mask", "وضع الماسك او ازالته", {}, false, function(source, args)
